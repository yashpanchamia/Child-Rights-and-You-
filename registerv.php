...
<div class="row" style="margin-top:50px">
    ...
    <form role="form" method="post" action="registerv.php">
<!--             <input type="hidden" name="csrfmiddlewaretoken" value="SxViUf1RZ9KkB3xWHQmMQKRp3oYOW7y7">
 -->      <fieldset>
        <div class="row">
              <a href="register.php" class="logo-color"><div class="col-xs-12 col-sm-12 col-md-12 inline logo-text"><h1>Register for Volunteer</h1>
              </div></a>
        </div>
...
$query = mysqli_query($conn,"INSERT INTO users
  ...
  VALUES('volunteer','$username','$password','$address','$email','$contact_no')");
  if($query === false)
            {
              ?>
                <script type="text/javascript">
